import { pgTable, integer, timestamp, varchar, boolean, index, bigint, jsonb, foreignKey, numeric, smallint, unique, text, doublePrecision, uniqueIndex, primaryKey, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const accountCurrencies = pgEnum("account_currencies", ['USD', 'EUR', 'CNY', 'GBP'])
export const adminNotificationVariants = pgEnum("admin_notification_variants", ['NEW_COMPLAINT', 'NEW_REVIEW', 'NEW_VENDOR_REGISTER', 'NEW_REFUND', 'NEW_NEGATIVE_REVIEW'])
...
export const complaintStateVariants = pgEnum("complaint_state_variants", ['DECLINED', 'ACCEPTED', 'IN_REVIEW'])
...
export const ordersStates = pgEnum("orders_states", ['CREATED', 'PACKED', 'DELIVERED', 'SUCCEED', 'CANCELED'])
export const paymentMethods = pgEnum("payment_methods", ['CARD'])
export const permitDirectories = pgEnum("permit_directories", ['ORDERS', 'DISCOUNTS', 'FINANCES', 'REFUNDS', 'CATEGORIES', 'REVIEWS'])
export const permitLevels = pgEnum("permit_levels", ['READ', 'CREATE', 'UPDATE', 'DELETE'])
export const productComplaintVariants = pgEnum("product_complaint_variants", ['INCORRECT_PRICE', 'INCORRECT_INFO', 'VENDOR_NOT_ANSWER', 'VIOLATES_TOS', 'FRAUD', 'OFFENSIVE_SPEAK', 'FORBIDDEN_SUBSTANCES', 'OTHER'])
export const productCustomPropVariants = pgEnum("product_custom_prop_variants", ['BOOL'])
export const productRefundReasonVariants = pgEnum("product_refund_reason_variants", ['DEFECTIVE_PRODUCT', 'OTHER'])
export const productRefundStateVariants = pgEnum("product_refund_state_variants", ['PENDING', 'REJECTED', 'ACCEPTED', 'CANCELLED'])
export const productSubBillsStateVariants = pgEnum("product_sub_bills_state_variants", ['PENDING', 'SUCCEED', 'FAILURE'])
export const productSubscriberStates = pgEnum("product_subscriber_states", ['ACTIVE', 'CANCELLED', 'AWAITING'])
export const productVariants = pgEnum("product_variants", ['SUBSCRIPTION', 'ONE_TIME', 'GOOD'])
export const reviewStateVariants = pgEnum("review_state_variants", ['PENDING', 'REJECTED', 'PUBLISHED'])
export const systemNotificationVariants = pgEnum("system_notification_variants", ['COMPLAINT_CREATED', 'REVIEW_CREATED', 'NEGATIVE_REVIEW_CREATED', 'VENDOR_REGISTER', 'PRODUCT_REFUND_CREATED'])
export const transactionStatusVariants = pgEnum("transaction_status_variants", ['PENDING', 'SUCCEED', 'FAILURE'])
...
export const vendorAccountTransactionVariants = pgEnum("vendor_account_transaction_variants", ['PAYOUT', 'ACCRUAL', 'ADJUSTING'])
export const vendorLegalFormVariants = pgEnum("vendor_legal_form_variants", ['COMPANY', 'INDIVIDUAL', 'SELF_EMPLOYED'])
export const vendorPayoutRequestStateVariants = pgEnum("vendor_payout_request_state_variants", ['PENDING', 'REJECTED', 'SUCCEED', 'CANCELLED'])


export const appVersions = pgTable("app_versions", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "app_versions_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
...
export const auditLog = pgTable("audit_log", {
	...
	index("idx_audit_record").using("btree", table.tableName.asc().nullsLast().op("text_ops"), table.recordId.asc().nullsLast().op("text_ops")),
]);

export const clientPayoutRequests = pgTable("client_payout_requests", {
	cprid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "client_payout_requests_cprid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	payoutRequestStateVariant: vendorPayoutRequestStateVariants("payout_request_state_variant").notNull(),
	cid: integer().notNull(),
...
export const clientReferrals = pgTable("client_referrals", {
	crid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "client_referrals_crid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
...
export const clients = pgTable("clients", {
	cid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "clients_cid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const clientPayoutRequisites = pgTable("client_payout_requisites", {
	cpr: integer().primaryKey().generatedByDefaultAsIdentity({ name: "client_payout_requisites_cpr_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	cid: integer().notNull(),
...
export const clientReferralsAccountTransactions = pgTable("client_referrals_account_transactions", {
	crid: integer(),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
...
export const productRefunds = pgTable("product_refunds", {
	prfid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_refunds_prfid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	cid: integer().notNull(),
	oid: integer(),
	pid: integer().notNull(),
	productRefundStateVariant: productRefundStateVariants("product_refund_state_variant").default('PENDING'),
	comment: text(),
	reason: text(),
...
export const bankCardTokens = pgTable("bank_card_tokens", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "bank_card_tokens_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	expiresAt: timestamp("expires_at", { mode: 'string' }),
...
export const vendorRequisites = pgTable("vendor_requisites", {
	vrqid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_requisites_vrqid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	vid: integer().notNull(),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const vendors = pgTable("vendors", {
	vid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendors_vid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const vendorAccountTransactions = pgTable("vendor_account_transactions", {
	vatid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_account_transactions_vatid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	vaid: integer().notNull(),
	totalAmount: numeric("total_amount", { precision: 15, scale:  2 }).default('0').notNull(),
	feeAmount: numeric("fee_amount", { precision: 15, scale:  2 }).default('0').notNull(),
	vendorAccountTransactionVariant: vendorAccountTransactionVariants("vendor_account_transaction_variant").notNull(),
	...
	index("idx_vat_account_time").using("btree", table.vaid.asc().nullsLast().op("int4_ops"), table.createdAt.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.vaid],
...
export const vendorPayoutRequests = pgTable("vendor_payout_requests", {
	vprid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_payout_requests_vprid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	vaid: integer().notNull(),
	totalAmount: numeric("total_amount", { precision: 15, scale:  2 }).default('0').notNull(),
	vbrid: integer(),
	vendorPayoutRequestStateVariant: vendorPayoutRequestStateVariants("vendor_payout_request_state_variant").default('PENDING'),
}, (table) => [
	foreignKey({
			columns: [table.vaid],
			foreignColumns: [vendorAccounts.vaid],
...
export const confirmationSmsCodes = pgTable("confirmation_sms_codes", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "confirmation_sms_codes_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const clientAddresses = pgTable("client_addresses", {
	caid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "client_addresses_caid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const media = pgTable("media", {
	mid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "media_mid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	...
	unique("media_path_key").on(table.path),
]);

export const vendorPhoneAuth = pgTable("vendor_phone_auth", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_phone_auth_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	phone: varchar({ length: 20 }).notNull(),
...
export const clientsPhoneAuth = pgTable("clients_phone_auth", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "clients_phone_auth_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	phone: varchar({ length: 20 }).notNull(),
	clientId: integer("client_id"),
...
export const managers = pgTable("managers", {
	maid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "managers_maid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const productPrices = pgTable("product_prices", {
	ppid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_prices_ppid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	pid: integer().notNull(),
	...
	uniqueIndex("product_prices_country_id_pid_duration_idx").using("btree", table.countryId.asc().nullsLast().op("float8_ops"), table.pid.asc().nullsLast().op("int4_ops"), table.duration.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.pid],
			foreignColumns: [products.pid],
...
export const managerPasswordAuth = pgTable("manager_password_auth", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "manager_password_auth_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	login: varchar({ length: 255 }).notNull(),
...
export const products = pgTable("products", {
	pid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "products_pid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	...
	index("idx_products_category_vendor").using("btree", table.pcid.asc().nullsLast().op("int4_ops"), table.vendorOwnerId.asc().nullsLast().op("int4_ops")),
	index("idx_products_country").using("btree", table.countryId.asc().nullsLast().op("int4_ops")),
	index("idx_products_vendor_id").using("btree", table.vendorOwnerId.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const productSubscribers = pgTable("product_subscribers", {
	psid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_subscribers_psid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	pid: integer().notNull(),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	...
	productSubscriberState: productSubscriberStates("product_subscriber_state").default('AWAITING'),
}, (table) => [
	foreignKey({
			columns: [table.pid],
			foreignColumns: [products.pid],
...
export const productSubBills = pgTable("product_sub_bills", {
	psbid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_sub_bills_psbid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	psid: integer().notNull(),
	total: numeric({ precision: 15, scale:  2 }).notNull(),
	productSubBillsStateVariant: productSubBillsStateVariants("product_sub_bills_state_variant").default('PENDING'),
}, (table) => [
...
export const productReviews = pgTable("product_reviews", {
	prid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_reviews_prid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	cid: integer(),
	pid: integer().notNull(),
	...
	vendorAnswerUpdatedAt: timestamp("vendor_answer_updated_at", { mode: 'string' }),
	...
	index("idx_reviews_state").using("btree", table.reviewStateVariant.asc().nullsLast().op("enum_ops")),
	foreignKey({
			columns: [table.cid],
			foreignColumns: [clients.cid],
...
export const clientReviews = pgTable("client_reviews", {
	crid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "client_reviews_crid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const productCategories = pgTable("product_categories", {
	pcid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_categories_pcid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const orders = pgTable("orders", {
	oid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "orders_oid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	clientId: integer("client_id"),
	...
	index("idx_orders_client_state").using("btree", table.clientId.asc().nullsLast().op("int4_ops"), table.orderState.asc().nullsLast().op("int4_ops")),
...
export const globalDiscounts = pgTable("global_discounts", {
	gdid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "global_discounts_gdid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const localDiscounts = pgTable("local_discounts", {
	ldid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "local_discounts_ldid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	startsAt: timestamp("starts_at", { mode: 'string' }),
	expiresAt: timestamp("expires_at", { mode: 'string' }),
...
export const orderToProducts = pgTable("order_to_products", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "order_to_products_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	productId: integer("product_id"),
	orderId: integer("order_id"),
	volume: integer(),
}, (table) => [
	index("idx_otp_order_id").using("btree", table.orderId.asc().nullsLast().op("int4_ops")),
	index("idx_otp_product_id").using("btree", table.productId.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const recommendedProducts = pgTable("recommended_products", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "recommended_products_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	productId: integer("product_id"),
...
export const productComplaints = pgTable("product_complaints", {
	psid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_complaints_psid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	cid: integer().notNull(),
	text: text(),
	...
	complaintStateVariant: complaintStateVariants("complaint_state_variant").default('IN_REVIEW').notNull(),
	isArchived: boolean("is_archived").default(false),
}, (table) => [
	foreignKey({
			columns: [table.cid],
...
export const articlePublications = pgTable("article_publications", {
	apid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "article_publications_apid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const adminNotifications = pgTable("admin_notifications", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	anid: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "admin_notifications_anid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
...
export const authSessions = pgTable("auth_sessions", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	asid: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "auth_sessions_asid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	clientId: integer("client_id"),
	managerId: integer("manager_id"),
	...
	lastRefreshTokenTime: timestamp("last_refresh_token_time", { mode: 'string' }),
}, (table) => [
	foreignKey({
			columns: [table.clientId],
			foreignColumns: [clients.cid],
...
export const vendorComplaints = pgTable("vendor_complaints", {
	vcid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_complaints_vcid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	cid: integer().notNull(),
	text: text(),
...
export const userGeolocations = pgTable("user_geolocations", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	uglid: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "user_geolocations_uglid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	cid: integer().notNull(),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
...
export const newsPublications = pgTable("news_publications", {
	npid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "news_publications_npid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	isPublished: boolean("is_published").default(true),
	isArchived: boolean("is_archived").default(false),
	slug: varchar({ length: 300 }),
...
export const conversations = pgTable("conversations", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	convid: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "conversations_convid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	pid: integer(),
	oid: integer(),
...
export const productCategoryProps = pgTable("product_category_props", {
	pcpid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_category_props_pcpid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	pcid: integer(),
...
export const integrationSpecs = pgTable("integration_specs", {
	isid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "integration_specs_isid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const dCountries = pgTable("d_countries", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "d_countries_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	isArchived: boolean("is_archived").default(false),
});

export const dBrands = pgTable("d_brands", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "d_brands_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	isArchived: boolean("is_archived").default(false),
});

export const convParticipants = pgTable("conv_participants", {
	convpid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "conv_participants_convpid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const convMessages = pgTable("conv_messages", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	mesid: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "conv_messages_mesid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	...
	index("idx_messages_convid_time").using("btree", table.convid.asc().nullsLast().op("int8_ops"), table.createdAt.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.convid],
			foreignColumns: [conversations.convid],
...
export const accessPermits = pgTable("access_permits", {
	apid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "access_permits_apid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	name: varchar({ length: 200 }),
...
export const dCustom = pgTable("d_custom", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "d_custom_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	isArchived: boolean("is_archived").default(false),
});
...
export const vendorBankRequisites = pgTable("vendor_bank_requisites", {
	vbrid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_bank_requisites_vbrid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	vid: integer().notNull(),
	vrqid: integer(),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const vendorAccounts = pgTable("vendor_accounts", {
	vaid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_accounts_vaid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	vid: integer().notNull(),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
...
export const dTransportCompanies = pgTable("d_transport_companies", {
	id: integer().primaryKey().generatedByDefaultAsIdentity({ name: "d_transport_companies_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	isArchived: boolean("is_archived").default(false),
});

export const productCustomProps = pgTable("product_custom_props", {
	pcpid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "product_custom_props_pcpid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	value: jsonb().notNull(),
	isArchived: boolean("is_archived").default(false),
...
export const clientPaymentMethods = pgTable("client_payment_methods", {
	cpmid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "client_payment_methods_cpmid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	clientId: integer("client_id"),
	type: paymentMethods(),
...
export const vendorReviews = pgTable("vendor_reviews", {
	vrid: integer().primaryKey().generatedByDefaultAsIdentity({ name: "vendor_reviews_vrid_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 2147483647, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
...
export const systemNotifications = pgTable("system_notifications", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "system_notifications_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow().notNull(),
	systemNotificationVariant: systemNotificationVariants("system_notification_variant").notNull(),
...
export const productRefundMedia = pgTable("product_refund_media", {
	mid: integer().notNull(),
...
export const productProps = pgTable("product_props", {
	pid: integer().notNull(),
...
export const productReviewMedia = pgTable("product_review_media", {
...
export const clientReviewMedia = pgTable("client_review_media", {
...
export const vendorProductDiscounts = pgTable("vendor_product_discounts", {
...
export const productComplaintMedia = pgTable("product_complaint_media", {
	psid: integer().notNull(),
	mid: integer().notNull(),
}, (table) => [
	foreignKey({
...
export const vendorComplaintMedia = pgTable("vendor_complaint_media", {
	mid: integer().notNull(),
...
export const managersAccessPermits = pgTable("managers_access_permits", {
...
export const vendorReviewMedia = pgTable("vendor_review_media", {
...
export const clientFavProducts = pgTable("client_fav_products", {
	createdAt: timestamp("created_at", { mode: 'string' }).defaultNow(),
	...
	primaryKey({ columns: [table.clientId, table.productId], name: "client_fav_products_pkey"}),
]);

export const adminNotificationReadStates = pgTable("admin_notification_read_states", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	primaryKey({ columns: [table.anid, table.maid], name: "admin_notification_read_states_pkey"}),
]);

export const dCountryValuesLocalizations = pgTable("d_country_values_localizations", {
	id: integer().notNull(),
	name: varchar({ length: 100 }),
	...
	primaryKey({ columns: [table.id, table.language], name: "d_country_values_localizations_pkey"}),
]);

export const dBrandValuesLocalizations = pgTable("d_brand_values_localizations", {
	id: integer().notNull(),
	name: varchar({ length: 100 }),
	language: languageVariants().notNull(),
}, (table) => [
	...
	primaryKey({ columns: [table.id, table.language], name: "d_brand_values_localizations_pkey"}),
]);

export const dTransportCompaniesLocalizations = pgTable("d_transport_companies_localizations", {
	id: integer().notNull(),
	name: varchar({ length: 100 }),
	language: languageVariants().notNull(),
}, (table) => [
	...
	primaryKey({ columns: [table.id, table.language], name: "d_transport_companies_localizations_pkey"}),
]);

export const globalDiscountMembers = pgTable("global_discount_members", {
...
export const dCustomValuesLocalizations = pgTable("d_custom_values_localizations", {
	id: integer().notNull(),
	name: varchar({ length: 100 }),
	language: languageVariants().notNull(),
}, (table) => [
	...
	primaryKey({ columns: [table.id, table.language], name: "d_custom_values_localizations_pkey"}),
]);

export const productCategoryLocalizations = pgTable("product_category_localizations", {
	pcid: integer().notNull(),
	name: varchar({ length: 100 }),
	...
	primaryKey({ columns: [table.pcid, table.language], name: "product_category_localizations_pkey"}),
]);
...
export const productMedia = pgTable("product_media", {
	...
	primaryKey({ columns: [table.pid, table.mediaId, table.language], name: "product_media_pkey"}),
]);

export const productCategoryPropLocalization = pgTable("product_category_prop_localization", {
	pcpid: integer().notNull(),
	name: varchar({ length: 200 }),
	...
	primaryKey({ columns: [table.pcpid, table.language], name: "product_category_prop_localization_pkey"}),
]);

export const productCustomPropLocalizations = pgTable("product_custom_prop_localizations", {
	pcpid: integer().notNull(),
	name: varchar({ length: 200 }),
	description: varchar({ length: 1000 }),
	language: languageVariants().notNull(),
	...
	primaryKey({ columns: [table.pcpid, table.language], name: "product_custom_prop_localizations_pkey"}),
]);

export const productRemains = pgTable("product_remains", {
	pid: integer().notNull(),
	vid: integer().notNull(),
	updatedAt: timestamp("updated_at", { mode: 'string' }),
	...
	primaryKey({ columns: [table.pid, table.vid, table.country], name: "product_remains_pkey"}),
]);
...
export const articlePublicationLocalizations = pgTable("article_publication_localizations", {
	...
	primaryKey({ columns: [table.apid, table.language], name: "article_publication_localizations_pkey"}),
]);

export const newsPublicationLocalizations = pgTable("news_publication_localizations", {
	...
	primaryKey({ columns: [table.npid, table.language], name: "news_publication_localizations_pkey"}),
]);
