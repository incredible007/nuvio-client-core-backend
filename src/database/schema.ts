...
export const accountCurrencies = pgEnum('account_currencies', [
    'USD',
    'EUR',
    'CNY',
    'GBP',
...
export const dataTypeVariants = pgEnum('data_type_variants', [
    'TEXT',
    'BOOL',
    'NUMBER',
]);
...
export const managerTypes = pgEnum('manager_types', [
    'CONTENT_MANAGER',
    'ADMIN',
]);
...
export const permitLevels = pgEnum('permit_levels', [
    'READ',
    'CREATE',
    'UPDATE',
    'DELETE',
...
export const productCustomPropVariants = pgEnum(
    'product_custom_prop_variants',
    ['BOOL'],
);
export const productRefundReasonVariants = pgEnum(
    'product_refund_reason_variants',
    ['DEFECTIVE_PRODUCT', 'OTHER'],
);
export const productRefundStateVariants = pgEnum(
    'product_refund_state_variants',
    ['PENDING', 'REJECTED', 'ACCEPTED', 'CANCELLED'],
);
export const productSubBillsStateVariants = pgEnum(
    'product_sub_bills_state_variants',
    ['PENDING', 'SUCCEED', 'FAILURE'],
);
...
export const productVariants = pgEnum('product_variants', [
    'SUBSCRIPTION',
    'ONE_TIME',
    'GOOD',
]);
...
export const systemNotificationVariants = pgEnum(
    'system_notification_variants',
    [
        'COMPLAINT_CREATED',
        'REVIEW_CREATED',
...
export const userTypeVariants = pgEnum('user_type_variants', [
    'MANAGER',
    'CLIENT',
    'VENDOR',
]);
export const userTypes = pgEnum('user_types', ['MANAGER', 'CLIENT', 'COURIER']);
export const vendorAccountTransactionVariants = pgEnum(
    'vendor_account_transaction_variants',
    ['PAYOUT', 'ACCRUAL', 'ADJUSTING'],
);
...
export const vendorPayoutRequestStateVariants = pgEnum(
    'vendor_payout_request_state_variants',
    ['PENDING', 'REJECTED', 'SUCCEED', 'CANCELLED'],
);
...
export const clientReferrals = pgTable(
    'client_referrals',
    {
        ...
        personalRateVolume: smallint('personal_rate_volume')
            .default(0)
            .notNull(),
...
export const clients = pgTable(
    'clients',
    {
        ...
        allowOrderNotifications: boolean('allow_order_notifications').default(
            true,
        ),
...
export const productRefunds = pgTable(
    'product_refunds',
    {
        ...
        comment: text(),
        reason: text(),
        productRefundReasonVariant: productRefundReasonVariants(
            'product_refund_reason_variant',
        ),
...
export const vendorRequisites = pgTable(
    'vendor_requisites',
    {
        ...
        vendorLegalFormVariant: vendorLegalFormVariants(
            'vendor_legal_form_variant',
        ).notNull(),
        isArchived: boolean('is_archived').default(false),
    },
    (table) => [
...
export const vendorAccountTransactions = pgTable(
    'vendor_account_transactions',
    {
        ...
        transactionStatusVariant: transactionStatusVariants(
            'transaction_status_variant',
        ).notNull(),
        version: integer().default(1).notNull(),
    },
    (table) => [
        index('idx_vat_account').using(
            'btree',
...
export const productPrices = pgTable(
    ...
    (table) => [
        uniqueIndex('product_prices_country_id_pid_duration_idx').using(
            'btree',
            table.countryId.asc().nullsLast().op('float8_ops'),
            table.pid.asc().nullsLast().op('int4_ops'),
            table.duration.asc().nullsLast().op('int4_ops'),
        ),
        foreignKey({
            columns: [table.pid],
            foreignColumns: [products.pid],
...
export const products = pgTable(
    'products',
    {
        ...
        productVariant: productVariants('product_variant')
            .default('GOOD')
            .notNull(),
        isArchived: boolean('is_archived').default(false),
...
export const productSubscribers = pgTable(
    'product_subscribers',
    {
        ...
        productSubscriberState: productSubscriberStates(
            'product_subscriber_state',
        ).default('AWAITING'),
    },
    (table) => [
        foreignKey({
...
export const productSubBills = pgTable(
    'product_sub_bills',
    {
        ...
        productSubBillsStateVariant: productSubBillsStateVariants(
            'product_sub_bills_state_variant',
        ).default('PENDING'),
    },
    (table) => [
        index('idx_psb_subscriber').using(
            'btree',
...
export const productReviews = pgTable(
    'product_reviews',
    {
        ...
        vendorAnswerUpdatedAt: timestamp('vendor_answer_updated_at', {
            mode: 'date',
        }),
        reviewStateVariant: reviewStateVariants('review_state_variant').default(
            'PENDING',
        ),
    },
    (table) => [
...
export const orders = pgTable(
    ...
    (table) => [
        ...
        index('idx_orders_state').using(
            'btree',
            table.orderState.asc().nullsLast().op('enum_ops'),
        ),
        foreignKey({
            columns: [table.clientId],
            foreignColumns: [clients.cid],
...
export const productComplaints = pgTable(
    'product_complaints',
    {
        ...
        pid: integer().notNull(),
        complaintVariant:
            productComplaintVariants('complaint_variant').notNull(),
...
export const adminNotifications = pgTable(
    'admin_notifications',
    {
        ...
        adminNotificationVariant: adminNotificationVariants(
            'admin_notification_variant',
        ).notNull(),
...
export const authSessions = pgTable(
    'auth_sessions',
    {
        ...
        lastRefreshTokenTime: timestamp('last_refresh_token_time', {
            mode: 'date',
        }),
    },
    (table) => [
...
export const convMessages = pgTable(
    ...
    (table) => [
        index('idx_messages_convid').using(
            'btree',
...
export const vendorAccounts = pgTable(
    'vendor_accounts',
    {
        ...
        feeDefault: numeric('fee_default', { precision: 15, scale: 2 }).default(
            '0',
        ),
        isArchived: boolean('is_archived').default(false),
...
export const productCustomProps = pgTable(
    ...
    (table) => [
        index('idx_custom_props_value').using(
            'gin',
...
export const productRefundMedia = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.mid, table.prfid],
            name: 'product_refund_media_pkey',
        }),
    ],
);
...
export const productProps = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.pid, table.pcpid],
            name: 'product_props_pkey',
        }),
    ],
);
...
export const productReviewMedia = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.prid, table.mid],
            name: 'product_review_media_pkey',
        }),
    ],
);
...
export const clientReviewMedia = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.crid, table.mid],
            name: 'client_review_media_pkey',
        }),
    ],
);
...
export const categoryDiscounts = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.discountId, table.pcid],
            name: 'category_discounts_pkey',
        }),
    ],
);
...
export const vendorProductDiscounts = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.ldid, table.pid],
            name: 'vendor_product_discounts_pkey',
        }),
    ],
);
...
export const productComplaintMedia = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.psid, table.mid],
            name: 'product_complaint_media_pkey',
        }),
    ],
);
...
export const vendorComplaintMedia = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.mid, table.vcid],
            name: 'vendor_complaint_media_pkey',
        }),
    ],
);
...
export const managersAccessPermits = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.maid, table.mapid],
            name: 'managers_access_permits_pkey',
        }),
    ],
);
...
export const vendorReviewMedia = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.vrid, table.mid],
            name: 'vendor_review_media_pkey',
        }),
    ],
);
...
export const globalDiscountMembers = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.gdid, table.vid],
            name: 'global_discount_members_pkey',
        }),
    ],
);
...
export const productLocalizations = pgTable(
    ...
    (table) => [
        ...
        primaryKey({
            columns: [table.pid, table.language],
            name: 'product_localizations_pkey',
        }),
    ],
);
